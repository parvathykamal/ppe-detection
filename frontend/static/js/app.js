...
class SimpleDashboard {
    ...
    async handleFile(file) {
        ...
        // Update upload area - show simple "File uploaded" message
        const uploadArea = document.getElementById('uploadArea');
    ...
    async updateStats() {
        ...
        try {
            ...
            if (!stats.error) {
                // Update detection summary values
                this.animateValue('statPPE2', stats.ppe_violations);
                this.animateValue('statFire2', stats.fire_detections);
                this.animateValue('statSmoke2', stats.smoke_detections);
                this.animateValue('statAlerts2', stats.total_alerts);
                
                // Show the summary card after processing
